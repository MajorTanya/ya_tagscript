"""
Debug Block copied from Leg3ndary's bTagScript, licensed under Creative Commons
Attribution 4.0 International License (CC BY 4.0).

cf. https://github.com/Leg3ndary/bTagScript/blob/945b8e34750debea714d36de863412e189975c1b/bTagScript/block/util_blocks/debug_block.py
"""
...
class DebugBlock(Block):
    ...
    **Examples:**
    ...
    .. tagscript::
        ...
        Running this would provide the output Bye, using the debug block below:
        {debug}
        ...
        This allows you to see that you forgot to parse with a delimiter which will lead to easy fixing.
    """
    ...
    def process(
        self, ctx: Context
    ) -> Optional[str]:  # pylint: disable=too-many-branches
        """
        Debug the tagscript!
        """
        debug = {}
